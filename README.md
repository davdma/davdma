...
* `floodmaps` contains code for the Sentinel-2 satellite imagery data pipeline and water pixel detection model that I have been recently working on at Argonne this year.
<!--
